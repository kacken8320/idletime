...
func InsertActivity(pool *pgxpool.Pool, categoryID int, name string, multiplier float32, minTime int, timeSpent int, skipCount int) {
...
func InsertCategory(pool *pgxpool.Pool, name string, multiplier float32) {
...
func GetCategoryMultiplier(pool *pgxpool.Pool, categoryID int) float32 {
	var categoryMultiplier float32
